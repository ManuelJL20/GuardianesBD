...
namespace Guardian_BD_beta
{
    ...
    {
        #region "METODOS"
        public bool datosok(ErrorProvider Error, NumericUpDown nro, DateTimePicker fec, ComboBox grado, ComboBox cargo, ComboBox sangre, TextBox ci, TextBox celu, TextBox num, TextBox nombre, TextBox apellidos, TextBox correo, DataGridView dataGridView1)
        {
            bool resp = true;
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                if (ci.Text == dataGridView1.Rows[v].Cells[1].Value.ToString())
                                                                {
                                                                    resp = false;
                                                                    MessageBox.Show("El número de carnet ya existe.", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                    Error.SetError(ci, "El número de carnet ya existe");
                                                                }
                                                                else
                                                                    Error.SetError(ci, "");
                                                            ...
                                                            for (int v = 0; v < dataGridView1.Rows.Count - 1; v++)
                                                            {
                                                                if (nro.Value == Convert.ToInt32(dataGridView1.Rows[v].Cells[0].Value.ToString()))
                                                                {
                                                                    resp = false;
                                                                    MessageBox.Show("El número de antigüedad ya se encuentra en uso. Inserte otro número por favor", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                    Error.SetError(nro, "El número de antigüedad ya se encuentra en uso");
                                                                }
                                                                else
                                                                    Error.SetError(nro, "");
